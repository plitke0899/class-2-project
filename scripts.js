$('.card').on('click', function () {
    ...
    if (artist === 'The 1975') {
        $('#column-right').css('background-image', 'url("https://en.wikipedia.org/wiki/Being_Funny_in_a_Foreign_Language#/media/File:The_1975_-_Being_Funny_in_a_Foreign_Language.png")')
    }
})